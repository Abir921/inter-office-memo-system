...
export default async function AppLayout({
  ...
  // The real guard. Middleware only performs a fast redirect; this is the
  // check that decides whether the page renders at all.
    ...
    <div className="min-h-dvh">
      <header className="sticky top-0 z-50 h-14 border-b border-rule bg-paper">
        <div className="flex h-14 items-center gap-3 px-4 sm:px-6">
          <Nav isAdmin={isAdmin(user)} counts={{ inbox: inboxCount, notifications: unread }} />
